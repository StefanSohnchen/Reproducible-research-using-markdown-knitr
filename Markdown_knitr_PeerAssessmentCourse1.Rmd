...
3. We display the first few rows of the ```activity``` data frame:
...
# Look up the value of interval at this position
...
Remplace each ```NA``` value by the mean of the **steps** attribute.
...
These formulas return a mean and median of **10766** and **10766** respectively.

These values differ from the estimates from the first part of the assignment. The impact of imputing the missing values is to have more data to obtain a bigger mean and median value.
